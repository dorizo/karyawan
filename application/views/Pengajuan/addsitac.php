                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="transaksiNote" readonly value="<?=$sitax->sitax_list?>" class="form-control" placeholder="">
                      </div>
                      
                     
                      <div class="form-group">
                      <input type="hidden" name="nilai_jasa" value="<?=$sitax->sitax_total?>" class="nilai_jasa form-control number-separator" value="0" placeholder="">
                      ...
                      <input type="text" name="transaksiJumlah" readonly value="<?=$sitax->sitax_total?>" class="form-control number-separator" placeholder="">
                      </div>
